...
import tensorflow.python.math as math
...
class MultiCategoricalPdType(PdType):
    ...
    def pdfromlatent(self, latent, init_scale=1.0, init_bias=0.0):
        pdparam = _matching_fc(latent, 'pi', self.ncats.sum(
...
class DiagGaussianPdType(PdType):
    ...
    def pdfromlatent(self, latent_vector, init_scale=1.0, init_bias=0.0):
        mean = _matching_fc(latent_vector, 'pi', self.size,
                            init_scale=init_scale, init_bias=init_bias)
...
class BernoulliPd(Pd):
    ...
    def sample(self):
        ...
        return tf.to_float(math.less(u, self.ps))
